# Projet Carent - Location de voitures
...
Dans cette archive on pourra trouver:
  ...
  - Un second dossier: Front-end -> Contient le projet Angular.
  - Un premier dossier: Container-bdd -> Contient le dockerfile et le fichier sql pour l'initialisation de la bdd.
